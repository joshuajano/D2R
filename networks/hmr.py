...
class HMR(nn.Module):
    ...
    def forward(self, x, struct_feat, combineLayer, idxs, is_struct =False, init_pose=None, init_shape=None, init_cam=None, n_iter=3):
        ...
        #===Add===
        if is_struct:
            img_cat_struct = torch.cat((x[idxs].clone(), struct_feat), 1)
