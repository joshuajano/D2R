...
"""
This code adopts the original DeblurGAN-V2
Orest Kupyn et al. Deblurgan-v2: Deblurring (orders-of-magnitude) faster and better, ICCV 2019
"""
import torch
...
class FPNInception(nn.Module):
    ...
    def __init__(self, output_ch=3, num_filters=128, num_filters_fpn=256):
        ...
        # norm_layer = functools.partial(nn.BatchNorm2d, affine=False, track_running_stats=True)
